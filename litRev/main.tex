...
\footnotetext{Here I use \textbf{recovery resilience} (recovery time to equilibrium) and \textbf{resistance} to describe the whole process of ecological resilience (see why in section \ref{res})}
...
In a metapopulation level, genetic variability...
